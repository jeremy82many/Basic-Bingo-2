...
public class RandomNumberGeneratorB : MonoBehaviour {
	...
	//if else statements are only in this script to make sure 0 is never drawn
...
//	B1.text = finishedList [0].ToString();
//else
//	B1.text = finishedList [1].ToString();
//if(finishedList[2] != 0)
//	B2.text = finishedList [2].ToString();
//else
//	B2.text = finishedList [3].ToString();
//if(finishedList[4] != 0)
//	B3.text = finishedList [4].ToString();
//else
//	B3.text = finishedList [5].ToString();
//if(finishedList[6] != 0)
//	B4.text = finishedList [6].ToString();
//else
//	B4.text = finishedList [7].ToString();
//if(finishedList[8] != 0)
//	B5.text = finishedList [8].ToString();
//else
//	B5.text = finishedList [9].ToString();